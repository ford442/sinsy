...
pkgdatadir = $(datadir)/sinsy
pkgincludedir = $(includedir)/sinsy
pkglibdir = $(libdir)/sinsy
pkglibexecdir = $(libexecdir)/sinsy
...
ACLOCAL = ${SHELL} /workspaces/sinsy/config/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = /workspaces/sinsy/emsdk/upstream/emscripten/emar
AUTOCONF = ${SHELL} /workspaces/sinsy/config/missing autoconf
AUTOHEADER = ${SHELL} /workspaces/sinsy/config/missing autoheader
AUTOMAKE = ${SHELL} /workspaces/sinsy/config/missing automake-1.16
AWK = gawk
CC = /workspaces/sinsy/emsdk/upstream/emscripten/emcc
...
LIBS = -lm 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /workspaces/sinsy/config/missing makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = sinsy
PACKAGE_BUGREPORT = http://sinsy.sourceforge.net/
PACKAGE_NAME = sinsy
PACKAGE_STRING = sinsy 0.92
PACKAGE_TARNAME = sinsy
PACKAGE_URL = 
PACKAGE_VERSION = 0.92
PATH_SEPARATOR = :
RANLIB = /workspaces/sinsy/emsdk/upstream/emscripten/emranlib
SET_MAKE = 
SHELL = /bin/bash
STRIP = strip
VERSION = 0.92
abs_builddir = /workspaces/sinsy
abs_srcdir = /workspaces/sinsy
abs_top_builddir = /workspaces/sinsy
abs_top_srcdir = /workspaces/sinsy
ac_ct_CC = 
ac_ct_CXX = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /workspaces/sinsy/config/install-sh
...
SUBDIRS = lib bin dic
include_HEADERS = include/sinsy.h
